...
---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "commonmenu", Texture = "arrowleft", X = 415, Y = 5, Width = 25, Height = 25 },
    RightArrow = { Dictionary = "commonmenu", Texture = "arrowright", X = 430, Y = 5, Width = 25, Height = 25 },
    Text = { X = 433, Y = 5, Scale = 0.25 },
}
